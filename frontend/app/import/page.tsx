...
export default function ImportPage() {
  ...
  const uploadFile = async (file: File) => {
    ...
    if (!allowedTypes.includes(file.type)) {
      setError('Invalid file type. Supported: PDF, Excel, CSV, Images');
      return;
    }
  ...
  return (
    <DashboardLayout 
      title="Import" 
      subtitle="Upload and process applicant data"
    >
        ...
        <div className="card p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="p-4 rounded-lg bg-gray-50">
              ...
              <p className="font-medium text-gray-900">PDF Forms</p>
              <p className="text-sm text-gray-500">
                Digital or scanned forms
              </p>
            </div>
            <div className="p-4 rounded-lg bg-gray-50">
              ...
              <p className="text-sm text-gray-500">
                Handwritten form scans
              </p>
            </div>
            <div className="p-4 rounded-lg bg-gray-50">
              <Upload className="w-8 h-8 text-purple-600 mb-2" />
              <p className="font-medium text-gray-900">OCR Support</p>
              <p className="text-sm text-gray-500">
